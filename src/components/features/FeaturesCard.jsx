...
const FeaturesCard = ({ Svg, title, desc }) => {
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
      <div className=" group mb-12">
        ...
        <h4 className="mb-3 text-xl font-bold text-dark ">{title}</h4>
        <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">{desc}</p>
        <a className="text-base font-medium text-dark hover:text-primary  dark:hover:text-primary">
          Learn More
        </a>
      </div>
    </div>
